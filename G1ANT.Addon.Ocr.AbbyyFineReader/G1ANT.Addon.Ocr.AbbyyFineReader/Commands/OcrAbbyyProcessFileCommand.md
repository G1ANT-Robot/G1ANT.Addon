...
| -------- | ---- | -------- | ------------- | ----------- |
|`path`| [text](G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes | | Path to a file to be processed |
|`pages`| [list](G1ANT.Language/G1ANT.Language/Structures/ListStructure.md) | no |                                                              | List of numbers of pages to be processed separated with [array separator](G1ANT.Manual/appendices/special-characters/array-separator.md) (❚), e.g. `1❚5❚6` |
|`tablescountresult`| [integer](G1ANT.Language/G1ANT.Language/Structures/IntegerStructure.md) | no | | Number of tables in the processed file |
|`language`| [text](G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | no |  | Language which should be considered during text recognition |
